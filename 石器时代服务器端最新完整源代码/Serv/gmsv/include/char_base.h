...
#define CHAR_FS_PARTYCHAT	(1 << 2)	//队伍频道开关
#define CHAR_FS_TRADECARD	(1 << 3)
#define CHAR_FS_TRADE			(1 << 4)
#ifdef _CHANNEL_MODIFY
#define CHAR_FS_TELL			(1 << 5)	//密语频道开关
#define CHAR_FS_FM				(1 << 6)	//家族频道开关
#ifdef _VERSION_NEW
#define	CHAR_FS_OCC				(1 << 7)	//职业频道开关
#endif
#define	CHAR_FS_SAVE			(1 << 8)	//对话储存开关
#define CHAR_FS_CHAT			(1 << 9)	//聊天室开关
#ifdef _THE_WORLD_SEND
#define CHAR_FS_WORLD			(1 << 10)	//世界频道开关
#endif

#ifdef _ONLINE_TALK_IP
#define CHAR_FS_TALKIP			(1 << 12)	//举报频道开关
#endif
...
typedef enum
{
	...
	CHAR_WORKTOITEMINDEX, // 物品序号

#ifdef _NEW_STREET_VENDOR
	CHAR_WORKSTREETVENDORTYPE, // 摆摊类型
#endif
	
#ifdef _TALK_CHECK
	CHAR_WORK_TALKCHECK,  // 说话验证
#endif
  ...
  CHAR_WORKPASSIVE_DUCK,				//闪避
  CHAR_WORKPASSIVE_ACURATE,		//命中
  CHAR_WORKPASSIVE_CRITICAL,		//暴击
  CHAR_WORKPASSIVE_COUNTER,		//反击
  CHAR_WORKPASSIVE_MULTIPLE,		//倍数
#endif
#ifdef _JZ_NEWSCRIPT_LUA
